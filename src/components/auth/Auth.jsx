...
const Auth = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        err.response?.data?.error || err.response?.data || "An error occurred.",
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#0b1120", fontFamily: "'Inter', sans-serif" }}
    >
      <div
      ...
      >
        ...
        <p className="mb-4" style={{ color: "#94a3b8", fontSize: "0.95rem" }}>
          {isLogin
            ? "Log in to your elite learning ecosystem."
            : "Join the elite learning ecosystem today."}
        </p>
          ...
          <div className="mb-3">
            ...
            <div className="input-group">
              <span
                ...
                style={{ backgroundColor: "#111827", color: "#64748b" }}
              >
            ...
            {!isLogin && password.length > 0 && (
              <div className="mt-3">
                ...
                >
                  ...
                  <span
                    style={{
                      color: strengthScore >= 4 ? "#8b5cf6" : strengthColor,
                    }}
                  >
                    {strengthLabel}
                  </span>
